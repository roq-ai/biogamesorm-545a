          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Total Offers" text={data?.total_offers} />

                <FormListItem label="Total Inventory" text={data?.total_inventory} />

                <FormListItem label="Total Customers" text={data?.total_customers} />
