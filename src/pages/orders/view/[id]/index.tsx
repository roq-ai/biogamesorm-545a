          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Order Sales Manager Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_order_sales_manager_idTouser?.id}`}>
                        {data?.user_order_sales_manager_idTouser?.email}
                      </Link>
                    }
                  />
                )}
