...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`biogamesorm`}</title>

        <meta
          name="description"
          content="Biogamesorm: Streamlining Your Furniture Export-Import Business with Comprehensive Order Management, Efficient Stock Control, and Insightful Statistics. Elevate Your Business to New Heights."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmdXJuaXR1cmV8ZW58MHx8fHwxNjk2MTg2NzcxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@phillipgold?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Phillip Goldsberry`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Biogamesorm: Streamlining Your Furniture Export-Import Business with Comprehensive Order Management, Efficient Stock Control, and Insightful Statistics. Elevate Your Business to New Heights.`}
            </Text>
            <Box
