  ...
  const columns: ColumnType[] = [
    ...
    { id: 'sale_price', header: 'sale_price', accessorKey: 'sale_price' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.import_date ? format(parseISO(record?.import_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'export_date',
      header: 'Export Date',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.export_date ? format(parseISO(record?.export_date as unknown as string), 'dd-MM-yyyy') : '',
    },
