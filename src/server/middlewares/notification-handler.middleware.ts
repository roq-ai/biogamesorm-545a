...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_created.create': {
    roles: ['business-owner', 'inventory-manager', 'sales-manager'],
    key: 'order',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'inventory-manager', 'sales-manager', 'customer'];
