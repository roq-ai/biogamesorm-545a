...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'inventory-manager', 'sales-manager', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Offers', path: '/offers', entity: 'offer', service: AccessServiceEnum.PROJECT, icon: FiBox },
